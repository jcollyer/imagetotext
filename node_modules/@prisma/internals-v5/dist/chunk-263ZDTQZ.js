...
var chunk_263ZDTQZ_exports = {};
__export(chunk_263ZDTQZ_exports, {
  getGeneratorSuccessMessage: () => getGeneratorSuccessMessage
});
module.exports = __toCommonJS(chunk_263ZDTQZ_exports);
...
function getGeneratorSuccessMessage(generator, time) {
  ...
  return `\u2714 Generated ${(0, import_chunk_DJGRU4RH.bold)(name)}${version ? ` (${version})` : ""}${to} in ${(0, import_chunk_XYCIH36R.formatms)(time)}`;
}
function formatVersion(generator) {
  const version = generator.manifest?.version;
  if (generator.getProvider() === "prisma-client-js") {
    const engineType = (0, import_chunk_IZRLOZAB.getClientEngineType)(generator.config);
    let engineHint = "";
...
function formatOutput(generator) {
  ...
  return output ? (0, import_chunk_DJGRU4RH.dim)(` to .${import_path.default.sep}${import_path.default.relative(process.cwd(), (0, import_chunk_UJCWYERA.parseEnvValue)(output))}`) : "";
}
