...
var chunk_5NVMK4T4_exports = {};
__export(chunk_5NVMK4T4_exports, {
  detect: () => detect,
  getCommand: () => getCommand
});
module.exports = __toCommonJS(chunk_5NVMK4T4_exports);
...
var Emitter = class {
  constructor() {
    (0, import_chunk_FVJ3R4NJ.__publicField)(this, "emitted", {
      afterExit: false,
      exit: false
    });
    (0, import_chunk_FVJ3R4NJ.__publicField)(this, "listeners", {
      afterExit: [],
      exit: []
    });
    (0, import_chunk_FVJ3R4NJ.__publicField)(this, "count", 0);
    (0, import_chunk_FVJ3R4NJ.__publicField)(this, "id", Math.random());
...
var SignalExit = class extends SignalExitBase {
  constructor(process2) {
    super();
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _processReallyExit);
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _processEmit);
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _hupSig, process$1.platform === "win32" ? "SIGINT" : "SIGHUP");
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _emitter, new Emitter());
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _process, void 0);
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _originalProcessEmit, void 0);
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _originalProcessReallyExit, void 0);
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _sigListeners, {});
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _loaded, false);
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _process, process2);
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _sigListeners, {});
    for (const sig of signals) {
      (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _sigListeners)[sig] = () => {
        const listeners = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).listeners(sig);
        let { count } = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter);
        const p = process2;
        ...
        if (listeners.length === count) {
          this.unload();
          const ret = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).emit("exit", null, sig);
          const s = sig === "SIGHUP" ? (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _hupSig) : sig;
          if (!ret)
            process2.kill(process2.pid, s);
        }
      };
    }
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _originalProcessReallyExit, process2.reallyExit);
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _originalProcessEmit, process2.emit);
  }
  onExit(cb, opts) {
    if (!processOk((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process))) {
      return () => {
      };
    }
    if ((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _loaded) === false) {
      this.load();
    }
    const ev = opts?.alwaysLast ? "afterExit" : "exit";
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).on(ev, cb);
    return () => {
      (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).removeListener(ev, cb);
      if ((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).listeners["exit"].length === 0 && (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).listeners["afterExit"].length === 0) {
        this.unload();
      }
    };
  }
  load() {
    if ((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _loaded)) {
      return;
    }
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _loaded, true);
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).count += 1;
    for (const sig of signals) {
      try {
        const fn = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _sigListeners)[sig];
        if (fn)
          (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).on(sig, fn);
      } catch (_) {
      }
    }
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).emit = (ev, ...a) => {
      return (0, import_chunk_FVJ3R4NJ.__privateMethod)(this, _processEmit, processEmit_fn).call(this, ev, ...a);
    };
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).reallyExit = (code) => {
      return (0, import_chunk_FVJ3R4NJ.__privateMethod)(this, _processReallyExit, processReallyExit_fn).call(this, code);
    };
  }
  unload() {
    if (!(0, import_chunk_FVJ3R4NJ.__privateGet)(this, _loaded)) {
    ...
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _loaded, false);
    signals.forEach((sig) => {
      const listener = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _sigListeners)[sig];
      if (!listener) {
        throw new Error("Listener not defined for signal: " + sig);
      }
      try {
        (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).removeListener(sig, listener);
      } catch (_) {
      }
    });
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).emit = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _originalProcessEmit);
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).reallyExit = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _originalProcessReallyExit);
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).count -= 1;
  }
};
...
_processReallyExit = /* @__PURE__ */ new WeakSet();
processReallyExit_fn = function(code) {
  if (!processOk((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process))) {
    return 0;
  }
  (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).exitCode = code || 0;
  (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).emit("exit", (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).exitCode, null);
  return (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _originalProcessReallyExit).call((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process), (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).exitCode);
};
_processEmit = /* @__PURE__ */ new WeakSet();
processEmit_fn = function(ev, ...args) {
  const og = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _originalProcessEmit);
  if (ev === "exit" && processOk((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process))) {
    if (typeof args[0] === "number") {
      (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).exitCode = args[0];
    }
    const ret = og.call((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process), ev, ...args);
    (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _emitter).emit("exit", (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process).exitCode, null);
    return ret;
  } else {
    return og.call((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _process), ev, ...args);
  }
};
...
var MaxBufferError = class extends Error {
  constructor() {
    ...
    (0, import_chunk_FVJ3R4NJ.__publicField)(this, "name", "MaxBufferError");
  }
};
...
var Queue = class {
  constructor() {
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _head, void 0);
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _tail, void 0);
    (0, import_chunk_FVJ3R4NJ.__privateAdd)(this, _size, void 0);
    this.clear();
  }
  enqueue(value) {
    const node = new Node(value);
    if ((0, import_chunk_FVJ3R4NJ.__privateGet)(this, _head)) {
      (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _tail).next = node;
      (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _tail, node);
    } else {
      (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _head, node);
      (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _tail, node);
    }
    (0, import_chunk_FVJ3R4NJ.__privateWrapper)(this, _size)._++;
  }
  dequeue() {
    const current = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _head);
    if (!current) {
      return;
    }
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _head, (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _head).next);
    (0, import_chunk_FVJ3R4NJ.__privateWrapper)(this, _size)._--;
    return current.value;
  }
  clear() {
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _head, void 0);
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _tail, void 0);
    (0, import_chunk_FVJ3R4NJ.__privateSet)(this, _size, 0);
  }
  get size() {
    return (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _size);
  }
  *[Symbol.iterator]() {
    let current = (0, import_chunk_FVJ3R4NJ.__privateGet)(this, _head);
    while (current) {
      yield current.value;
