...
var chunk_7H46TMFS_exports = {};
__export(chunk_7H46TMFS_exports, {
  drawBox: () => drawBox
});
module.exports = __toCommonJS(chunk_7H46TMFS_exports);
...
var require_is_fullwidth_code_point = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_astral_regex = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_color_name = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_conversions = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_route = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_color_convert = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_ansi_styles = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_slice_ansi = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_emoji_regex = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var require_string_width = (0, import_chunk_FVJ3R4NJ.__commonJS)({
  "../../node_modules/.pnpm/string-width@4.2.3/node_modules/string-width/index.js"(exports, module2) {
    "use strict";
    var stripAnsi = (0, import_chunk_IYRLW4JM.require_strip_ansi)();
    var isFullwidthCodePoint = require_is_fullwidth_code_point();
...
var require_cli_truncate = (0, import_chunk_FVJ3R4NJ.__commonJS)({
...
var import_cli_truncate = (0, import_chunk_FVJ3R4NJ.__toESM)(require_cli_truncate());
var import_string_width = (0, import_chunk_FVJ3R4NJ.__toESM)(require_string_width());
var chars = {
  topLeft: "\u250C",
  topRight: "\u2510",
  bottomRight: "\u2518",
...
function drawBox({ title, width, height, str, horizontalPadding }) {
  ...
  const topLine = title ? (0, import_chunk_DJGRU4RH.grey)(chars.topLeft + chars.horizontal) + " " + (0, import_chunk_DJGRU4RH.reset)((0, import_chunk_DJGRU4RH.bold)(title)) + " " + (0, import_chunk_DJGRU4RH.grey)(chars.horizontal.repeat(width - title.length - 2 - 3) + chars.topRight) + (0, import_chunk_DJGRU4RH.reset)() : (0, import_chunk_DJGRU4RH.grey)(chars.topLeft + chars.horizontal) + (0, import_chunk_DJGRU4RH.grey)(chars.horizontal.repeat(width - 3) + chars.topRight);
  ...
  const mappedLines = lines.slice(-height).map((l) => {
    ...
    return `${(0, import_chunk_DJGRU4RH.grey)(chars.vertical)}${" ".repeat(horizontalPadding)}${(0, import_chunk_DJGRU4RH.reset)((0, import_cli_truncate.default)(l, width - 2))}${" ".repeat(
      paddingRight - horizontalPadding
    )}${(0, import_chunk_DJGRU4RH.grey)(chars.vertical)}`;
  }).join("\n");
  return (0, import_chunk_DJGRU4RH.grey)(topLine + "\n" + mappedLines + "\n" + bottomLine);
}
