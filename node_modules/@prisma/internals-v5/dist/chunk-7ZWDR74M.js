...
var chunk_7ZWDR74M_exports = {};
__export(chunk_7ZWDR74M_exports, {
...
module.exports = __toCommonJS(chunk_7ZWDR74M_exports);
var import_chunk_Y2NFETTY = require("./chunk-Y2NFETTY.js");
...
var import_fs_extra = (0, import_chunk_FVJ3R4NJ.__toESM)((0, import_chunk_Y2NFETTY.require_lib)());
var import_temp_dir = (0, import_chunk_FVJ3R4NJ.__toESM)((0, import_chunk_G3BTRIWS.require_temp_dir)());
...
async function maybeCopyToTmp(file) {
  ...
  if (dir.match(import_chunk_M3GBKLGE.vercelPkgPathRegex)) {
    ...
    (0, import_chunk_RK3Z3Z5H.chmodPlusX)(target);
    return target;
  }
  return file;
}
