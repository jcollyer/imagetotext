...
var chunk_EOIUMEUH_exports = {};
__export(chunk_EOIUMEUH_exports, {
  getEnginesInfo: () => getEnginesInfo,
  getEnginesMetaInfo: () => getEnginesMetaInfo,
  resolveEngine: () => resolveEngine
});
module.exports = __toCommonJS(chunk_EOIUMEUH_exports);
var import_chunk_4M6RGZMG = require("./chunk-4M6RGZMG.js");
var import_chunk_Q44S2PRF = require("./chunk-Q44S2PRF.js");
...
async function resolveEngine(binaryName) {
  ...
  const enginePathEither = await (0, import_function2.pipe)(
    pathFromEnvOption,
    fold(
      () => (0, import_chunk_7ZWDR74M.safeResolveBinary)(binaryName),
  ...
  const versionEither = await (0, import_function2.pipe)(
    ...
    (0, import_chunk_YJ2WM7K5.chain)((enginePath) => {
      return (0, import_chunk_Q44S2PRF.safeGetEngineVersion)(enginePath, binaryName);
    })
  )();
  const engineInfo = {
