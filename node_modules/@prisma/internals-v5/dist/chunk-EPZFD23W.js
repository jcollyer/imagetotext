...
var chunk_EPZFD23W_exports = {};
__export(chunk_EPZFD23W_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_EPZFD23W_exports);
var import_chunk_M2BC5C3V = require("./chunk-M2BC5C3V.js");
var import_chunk_2QIJNFCO = require("./chunk-2QIJNFCO.js");
...
[Context: getDmmf]`;
    super((0, import_chunk_2QIJNFCO.addVersionDetailsToErrorMessage)(errorMessageWithContext));
      ...
      return (0, import_function.pipe)(
        (0, import_chunk_YJ2WM7K5.tryCatch)(
          () => {
            ...
            const data = import_chunk_WCSPL6MU.prismaSchemaWasm.get_dmmf(params);
            return data;
          },
          (e) => ({
            type: "wasm-error",
