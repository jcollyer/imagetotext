...
var chunk_HYWHXF4Y_exports = {};
__export(chunk_HYWHXF4Y_exports, {
...
module.exports = __toCommonJS(chunk_HYWHXF4Y_exports);
...
async function getConfig(options) {
  const debugErrorType = (0, import_chunk_M2BC5C3V.createDebugErrorType)(debug, "getConfigWasm");
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_YJ2WM7K5.tryCatch)(
      () => {
        ...
        const data = import_chunk_TTXZEUOA.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
  ...
  if ((0, import_chunk_YJ2WM7K5.isRight)(configEither)) {
  ...
  const error = (0, import_chunk_KTERFAQE.N)(configEither.left).with({ type: "wasm-error" }, (e) => {
    debugErrorType(e);
    ...
    return new GetConfigError((0, import_chunk_M2BC5C3V.parseQueryEngineError)({ errorOutput, reason: e.reason }));
  }).otherwise((e) => {
    debugErrorType(e);
