...
var chunk_JD7BZWTA_exports = {};
__export(chunk_JD7BZWTA_exports, {
  require_graceful_fs: () => require_graceful_fs
});
module.exports = __toCommonJS(chunk_JD7BZWTA_exports);
...
var require_polyfills = (0, import_chunk_FVJ3R4NJ.__commonJS)({
  "../../node_modules/.pnpm/graceful-fs@4.2.10/node_modules/graceful-fs/polyfills.js"(exports, module2) {
    "use strict";
    var constants = (0, import_chunk_FVJ3R4NJ.__require)("constants");
    ...
    if (!fs[gracefulQueue]) {
      ...
      if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || "")) {
        process.on("exit", function() {
          ...
          (0, import_chunk_FVJ3R4NJ.__require)("assert").equal(fs[gracefulQueue].length, 0);
        });
      }
    }
    var queue;
