...
var chunk_LDAJSPFG_exports = {};
__export(chunk_LDAJSPFG_exports, {
...
module.exports = __toCommonJS(chunk_LDAJSPFG_exports);
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_YJ2WM7K5.tryCatch)(
      () => {
        ...
        const data = import_chunk_WCSPL6MU.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
