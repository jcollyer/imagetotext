...
var chunk_LWBY6A4I_exports = {};
__export(chunk_LWBY6A4I_exports, {
...
module.exports = __toCommonJS(chunk_LWBY6A4I_exports);
...
function lintSchema({ schema }) {
  const lintResult = import_chunk_WCSPL6MU.prismaSchemaWasm.lint(schema);
