...
var chunk_MCWIJA45_exports = {};
__export(chunk_MCWIJA45_exports, {
  getBinaryPathsByVersion: () => getBinaryPathsByVersion
});
module.exports = __toCommonJS(chunk_MCWIJA45_exports);
...
async function getBinaryPathsByVersion({
  ...
  for (const currentVersion in neededVersions) {
    ...
    if (process.env.NETLIFY) {
      ...
      const awsRuntimeVersion = (0, import_chunk_6UZD6PXW.parseAWSNodejsRuntimeEnvVarVersion)();
