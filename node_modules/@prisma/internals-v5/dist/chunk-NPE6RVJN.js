...
var chunk_NPE6RVJN_exports = {};
__export(chunk_NPE6RVJN_exports, {
  getCLIPathHash: () => getCLIPathHash,
  getProjectHash: () => getProjectHash
});
module.exports = __toCommonJS(chunk_NPE6RVJN_exports);
...
async function getProjectHash() {
  const args = (0, import_chunk_XCAO5Z7L.arg)(process.argv.slice(3), { "--schema": String });
  let projectPath = await (0, import_chunk_LXMH457V.getSchemaPath)(args["--schema"]);
