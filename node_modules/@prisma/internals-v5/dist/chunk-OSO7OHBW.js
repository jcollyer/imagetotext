...
var chunk_OSO7OHBW_exports = {};
__export(chunk_OSO7OHBW_exports, {
  locateLocalCloudflareD1: () => locateLocalCloudflareD1
});
module.exports = __toCommonJS(chunk_OSO7OHBW_exports);
...
var import_fast_glob = (0, import_chunk_FVJ3R4NJ.__toESM)((0, import_chunk_PN7UG7JB.require_out)());
...
async function locateLocalCloudflareD1({ arg }) {
  ...
  if (d1Databases.length > 1) {
    const { originalArg, recommendedArg } = (0, import_chunk_KTERFAQE.N)(arg).with("--to-local-d1", (originalArg2) => ({
