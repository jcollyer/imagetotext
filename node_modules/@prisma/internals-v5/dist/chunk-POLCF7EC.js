...
var chunk_POLCF7EC_exports = {};
__export(chunk_POLCF7EC_exports, {
  getEngineVersion: () => getEngineVersion,
  safeGetEngineVersion: () => safeGetEngineVersion
});
module.exports = __toCommonJS(chunk_POLCF7EC_exports);
...
async function getEngineVersion(enginePath, binaryName) {
  ...
  enginePath = await (0, import_chunk_5OL7Q2SP.resolveBinary)(binaryName, enginePath);
  ...
  if (binaryName === import_fetch_engine.BinaryType.QueryEngineLibrary) {
    ...
    const QE = (0, import_chunk_WKT5QKZS.loadLibrary)(enginePath, platformInfo);
...
function safeGetEngineVersion(enginePath, binaryName) {
  return (0, import_chunk_YJ2WM7K5.tryCatch2)(
