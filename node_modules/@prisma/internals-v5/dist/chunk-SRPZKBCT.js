...
var chunk_SRPZKBCT_exports = {};
__export(chunk_SRPZKBCT_exports, {
  findPrismaClientDir: () => findPrismaClientDir
});
module.exports = __toCommonJS(chunk_SRPZKBCT_exports);
...
async function findPrismaClientDir(baseDir) {
  ...
  const CLIDir = await (0, import_chunk_WIPBZJFE.resolvePkg)("prisma", resolveOpts);
  const clientDir = await (0, import_chunk_WIPBZJFE.resolvePkg)("@prisma/client", resolveOpts);
