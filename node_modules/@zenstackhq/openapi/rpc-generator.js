...
class RPCOpenAPIGenerator extends generator_base_1.OpenAPIGeneratorBase {
    ...
    generateField(def) {
        switch (def.kind) {
            ...
            default:
                throw new sdk_1.PluginError(this.options.name, `Unsupported field kind: ${def.kind}`);
        }
    }
        ...
        for (const field of output.fields) {
            ...
            switch (field.outputType.location) {
                ...
                case 'outputObjectTypes':
                    outputType = this.prismaTypeToOpenAPIType(typeof field.outputType.type === 'string' ? field.outputType.type : field.outputType.type.name, !!field.isNullable);
                    break;
            }
            field.outputType;
