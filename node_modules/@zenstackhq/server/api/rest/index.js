    ...
    processRequestBody(type, requestBody, zodSchemas, mode) {
        ...
        if (attributes) {
            ...
            if (payloadSchema) {
                ...
                if (!parsed.success) {
                    return {
                        error: this.makeError('invalidPayload', (0, zod_validation_error_1.fromZodError)(parsed.error).message, undefined, runtime_1.CrudFailureReason.DATA_VALIDATION_VIOLATION, parsed.error),
                    };
                }
            }
        }
    ...
    handlePrismaError(err) {
        ...
        if ((0, runtime_1.isPrismaClientKnownRequestError)(err)) {
            if (err.code === runtime_1.PrismaErrorCode.CONSTRAINED_FAILED) {
                return this.makeError('forbidden', undefined, 403, (_a = err.meta) === null || _a === void 0 ? void 0 : _a.reason, (_b = err.meta) === null || _b === void 0 ? void 0 : _b.zodErrors);
            }
