...
class RequestHandler extends base_1.APIHandlerBase {
    handleRequest({ prisma, method, path, query, requestBody, modelMeta, zodSchemas, logger, }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (error) {
                return { status: 400, body: this.makeError(error, runtime_1.CrudFailureReason.DATA_VALIDATION_VIOLATION, zodErrors) };
            }
            try {
                if (!prisma[model]) {
                ...
                if ((0, runtime_1.isPrismaClientKnownRequestError)(err)) {
                    ...
                    const { error } = this.makeError(err.message, (_b = err.meta) === null || _b === void 0 ? void 0 : _b.reason, (_c = err.meta) === null || _c === void 0 ? void 0 : _c.zodErrors);
                    return {
                        status,
                        body: {
