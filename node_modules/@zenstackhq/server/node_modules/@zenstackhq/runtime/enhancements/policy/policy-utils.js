 ...
 */
class PolicyUtil {
    constructor(db, options, modelMeta, policy, zodSchemas, user, shouldLogQuery = false) {
        this.db = db;
    ...
    deniedByPolicy(model, operation, extra, reason, zodErrors) {
        ...
        return (0, utils_1.prismaClientKnownRequestError)(this.db, this.options, `denied by policy: ${model} entities failed '${operation}' check${extra ? ', ' + extra : ''}`, args);
    }
    notFound(model) {
        return (0, utils_1.prismaClientKnownRequestError)(this.db, this.options, `entity not found for model ${model}`, {
            clientVersion: (0, version_1.getVersion)(),
            code: 'P2025',
        });
    }
    validationError(message) {
        return (0, utils_1.prismaClientValidationError)(this.db, this.options, message);
    }
    unknownError(message) {
        return (0, utils_1.prismaClientUnknownRequestError)(this.db, this.options, message, {
            clientVersion: (0, version_1.getVersion)(),
        });
    }
    //#endregion
     ...
     */
    getIdFields(model) {
        return (0, cross_1.getIdFields)(this.modelMeta, model, true);
    }
    /**
