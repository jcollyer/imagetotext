...
class TypeScriptExpressionTransformer {
    ...
    ensureBoolean(expr) {
        if (this.options.context === sdk_1.ExpressionContext.ValidationRule) {
    ...
    unary(expr, normalizeUndefined) {
        ...
        if (expr.operator === '!' &&
            this.options.context === sdk_1.ExpressionContext.ValidationRule &&
            (0, sdk_1.isDataModelFieldReference)(expr.operand)) {
    ...
    binary(expr, normalizeUndefined) {
        ...
        if (this.options.context === sdk_1.ExpressionContext.ValidationRule) {
            ...
            if (nullComparison) {
                ...
                if ((0, sdk_1.isDataModelFieldReference)(expr.right)) {
    ...
    extractNullComparison(expr) {
        ...
        else if ((0, sdk_1.isDataModelFieldReference)(expr.right) && (0, ast_1.isNullExpr)(expr.left)) {
